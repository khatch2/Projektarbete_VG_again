...
class VolumeInfo {
    ...
    override fun toString(): String {
        return "VolumeInfo(inside_inside_title='$inside_inside_title', inside_inside_authors='$inside_inside_authors', inside_inside_publisher='$inside_inside_publisher', inside_inside_publishedDate='$inside_inside_publishedDate', inside_inside_description='$inside_inside_description')"
    }
}
